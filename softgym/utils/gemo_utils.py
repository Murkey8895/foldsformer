...
def get_world_coords(rgb, depth, env):
    ...
    cam_x, cam_y, cam_z = (
        env.camera_params["default_camera"]["pos"][0],
        env.camera_params["default_camera"]["pos"][1],
        env.camera_params["default_camera"]["pos"][2],
    )
    cam_x_angle, cam_y_angle, cam_z_angle = (
        env.camera_params["default_camera"]["angle"][0],
        env.camera_params["default_camera"]["angle"][1],
